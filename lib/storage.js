...
import { collection, addDoc, setDoc, updateDoc, deleteDoc, doc, getDocs, getDoc, query, where, increment, orderBy, limit } from 'firebase/firestore'
...
export async function getTestimonios(cantidad = 4) {
  if (!db) return []
  try {
    const q = query(
