  ...
  const planes = [
    ...
    },
    {
      ...
      caracteristicas: [
        ...
        { texto: 'Servicios ofrecidos visible', incluido: true },
        { texto: 'Redes sociales visibles', incluido: true },
        { texto: 'Estadísticas de vistas y contactos', incluido: true, destacado: true },
    ...
    },
    {
      ...
      caracteristicas: [
        ...
        { texto: 'Hasta 10 fotos por negocio', incluido: true },
        { texto: 'Badge "Destacado" + "Verificado"', incluido: true, destacado: true },
        { texto: 'WhatsApp visible', incluido: true },
        { texto: 'Ubicación en Google Maps', incluido: true },
        { texto: 'Horario de atención visible', incluido: true },
        { texto: 'Servicios ofrecidos visible', incluido: true },
        { texto: 'Redes sociales visibles', incluido: true },
        { texto: 'Estadísticas avanzadas + reportes', incluido: true, destacado: true },
        { texto: 'Soporte premium 24/7', incluido: true },
      ],
    ...
    <div>
      ...
      <div className="container" style={{ paddingBottom: 60, maxWidth: 720, margin: '0 auto' }}>
        ...
        {[
          ...
          { p: '¿Hay período de prueba para planes pagos?', r: 'Sí, ofrecemos 7 días de prueba gratuita en cualquier plan pago. Si no te convence, cancela sin costo.' },
